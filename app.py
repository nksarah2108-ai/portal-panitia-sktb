...
# LINK GAMBAR (KEKALKAN FORMAT HD MOON)
...
# --- CUSTOM CSS: KEKALKAN SEMUA DESIGN ASAL ---
st.markdown("""
    <style>
    ...
    .cursive-blink {
        font-family: 'Dancing Script', cursive; font-size: 95px; color: #ad1457;
    ...
    .admin-img-box {
        width: 100%; max-width: 1000px; border-radius: 15px;
        box-shadow: 0 10px 30px rgba(0,0,0,0.15); margin-top: 20px; border: 5px solid #ffffff;
    }
