...
# LINK GAMBAR (FORMAT DIRECT DOWNLOAD - PALING STABIL)
LOGO_URL = "https://drive.google.com/uc?export=download&id=1XV1CIEWhms8jHqJGOKpSluqr7cxtSWrv"
PENTADBIR_URL = "https://drive.google.com/uc?export=download&id=1m87eH4bQ-p51DCMVjvM2ID8QgtwNF9ul"

# --- CUSTOM CSS: KUNCI MATI SEMUA DESIGN ---
st.markdown("""
    <style>
...
# --- 4. LAMAN PANITIA (LENGKAP SEMUA SUBTOPIK) ---
else:
    ...
    with col3:
        ...
        with st.expander("FAIL C 👇"):
            ...
            st.markdown(f'<a class="sublink" href="{links["PLC"]}" target="_blank">👥 PLC</a>', unsafe_allow_html=True)
    with col4:
        ...
        with st.expander("FAIL D 👇"):
            ...
            st.markdown(f'<a class="sublink" href="{links["JSU"]}" target="_blank">🔍 JSU</a>', unsafe_allow_html=True)
