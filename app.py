...
# LINK GAMBAR (Direct Links)
LOGO_URL = "https://drive.google.com/thumbnail?id=1XV1CIEWhms8jHqJGOKpSluqr7cxtSWrv"
PENTADBIR_URL = "https://drive.google.com/thumbnail?id=1m87eH4bQ-p51DCMVjvM2ID8QgtwNF9ul"
...
if pilihan == "🏠 LAMAN UTAMA":
    st.markdown(f"""
        <div class="center-wrapper">
            ...
            <div style="color:#ad1457; font-size:40px; font-weight:900; letter-spacing:4px;">SKTB 2026</div>
        </div>
    """, unsafe_allow_html=True)
    st.divider()
    st.markdown("<h2 style='text-align: center; color: #ad1457;'>👤 BARISAN PENTADBIR SKTB</h2>", unsafe_allow_html=True)
    st.markdown('<div class="center-wrapper">', unsafe_allow_html=True)
    st.image(PENTADBIR_URL, width=800, caption="Barisan Pentadbir Sekolah Kebangsaan Telok Berembang")
